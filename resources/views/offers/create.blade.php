...
<body id="body">
    ...
    <div class="registration-form">
        <form method="POST" action="{{route('offers.store')}}" id="form">
            ...
            <div class="form-group">
                <input type="number" class="form-control item" id="price" placeholder="price" name="price">
            </div>
            ...
            <div class="form-group">
                <button type="submit" class="registration-form" id="create_offer" placeholder="create_offer" name="create_offer">Add Your Offer</button>
            </div>
        </form>
    </div>
